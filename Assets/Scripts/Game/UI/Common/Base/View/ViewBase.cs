...
//
//         protected readonly Dictionary<Enum, AViewBase> SubViewsCache = new();
//
//         private void Awake()
//         {
...
//         {
//             var aView = GetSubView(subState) ?? throw new NullReferenceException("SubView is null. " + subState);
//
//             return new SubViewTemplateData
//             {
//                 InSafeZone = aView.inSafeZone,
//                 Template = aView.GetTemplate()
//             };
//         }
//
//         private AViewBase GetSubView(Enum subState)
//         {
...
//
//             foreach (var aView in SubViewsCache)
//             {
//                 Debug.LogWarning($"SubView in cache: {aView.Key} / {aView.Value}");
//             }
//
