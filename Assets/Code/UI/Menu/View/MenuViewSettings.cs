...
namespace Code.UI.Menu.View
{
    public class MenuViewSettings : CustomSubViewBase<IMenuViewModel>
    {
        ...
        {
            _header = RootContainer.GetVisualElement<Label>(UIElementId.TitleId, name);
        ...
        {
            _header.text = LocalizationManager.Localize(LocalizationNameID.Settings).ToUpper();
        ...
        {
            Debug.LogWarning("  InitializeCallbacks in MenuViewSettings");
