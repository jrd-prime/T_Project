...
using Code.Core.Managers.GameOLD;
...
namespace Code.Core.WORK.JStateMachine._Base
{
        ...
        where TUIModel : IUIModel<TSubStateEnum> where TSubStateEnum : Enum
    {
        ...
        [Inject]
        private void Construct(GameManager gameManager, IUIManager uiController, IHeroModel playerModel,
            TUIModel dataModel)
        {
